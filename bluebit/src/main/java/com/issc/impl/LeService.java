...
public class LeService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (fake) {
            android.util.Log.e("LeService","Use FakeGattAdapter for testing");
            Log.e("Use FakeGattAdapter for testing");
            mGattAdapter = new FakeGattAdapter(this, mCallback);
        } else {
            Log.e("Use AospGattAdapter");
            android.util.Log.e("LeService","Use AospGattAdapter");
